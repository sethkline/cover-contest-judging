...
function PaginationInfo({ currentPage, totalPages }: PaginationInfoProps) {
  return (
    <div className="text-sm text-neutral-600 dark:text-neutral-400">
      Page <span className="font-medium text-neutral-900 dark:text-white">{currentPage}</span> of <span className="font-medium text-neutral-900 dark:text-white">{totalPages}</span>
    </div>
  );
}