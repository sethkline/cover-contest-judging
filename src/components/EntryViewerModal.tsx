            ...
            <div className="grid md:grid-cols-2 gap-6">
              ...
              <div>
                <div className="space-y-4">
                  ...
                  <div className="mt-6">
                    <Tabs defaultValue="overview" variant="underline" onChange={(value) => setActiveTab(value)}>
                      <TabList className="mb-4 border-b border-gray-200">
                        <Tab value="overview">Overview</Tab>
                        <Tab value="detailed">All Scores</Tab>
                        {entry.comments?.length > 0 && <Tab value="comments">Comments</Tab>}
                      </TabList>
                      ...
                      <TabPanels>
                        ...
                        <TabPanel value="overview">
                          <div className="space-y-2">
                            <div className="flex justify-between items-center">
                              <h3 className="text-sm font-medium text-gray-700">Core Scores</h3>
                              <div className="text-sm font-bold text-gray-900">Total: {entry.scores.total}</div>
                            </div>
                            ...
                            <div className="mt-4 pt-4 border-t">
                              <p className="text-xs text-gray-500">
                                Judged by {entry.judgeCount} {entry.judgeCount === 1 ? 'judge' : 'judges'}
                              </p>
                            </div>
                          </div>
                        </TabPanel>
                        ...
                        <TabPanel value="detailed">
                          <div className="space-y-4">
                            {/* Core Criteria */}
                            <div>
                              <h3 className="text-sm font-medium text-gray-700 mb-1">Core Criteria</h3>
                              <table className="min-w-full">
                                <tbody>
                                  <tr>
                                    <td className="py-1 text-sm font-medium text-gray-900">Creativity:</td>
                            ...
                            {/* Thematic Elements */}
                            <div>
                              <h3 className="text-sm font-medium text-gray-700 mb-1">Thematic Elements</h3>
                              <table className="min-w-full">
                                <tbody>
                                  <tr>
                                    <td className="py-1 text-sm font-medium text-gray-900">Theme Interpretation:</td>
                                    <td className="py-1 text-sm text-gray-500">
                                      {entry.scores.themeInterpretation || 'N/A'}
                                    </td>
                                  </tr>
                                  <tr>
                                    <td className="py-1 text-sm font-medium text-gray-900">Movement:</td>
                                    <td className="py-1 text-sm text-gray-500">
                            ...
                            {/* Design Principles */}
                            <div>
                              <h3 className="text-sm font-medium text-gray-700 mb-1">Design Principles</h3>
                              <table className="min-w-full">
                                <tbody>
                                  <tr>
                                    <td className="py-1 text-sm font-medium text-gray-900">Composition:</td>
                                    <td className="py-1 text-sm text-gray-500">{entry.scores.composition || 'N/A'}</td>
                                  </tr>
                                  <tr>
                                    <td className="py-1 text-sm font-medium text-gray-900">Color Usage:</td>
                                    <td className="py-1 text-sm text-gray-500">{entry.scores.colorUsage || 'N/A'}</td>
                                  </tr>
                                  <tr>
                                    <td className="py-1 text-sm font-medium text-gray-900">Visual Focus:</td>
                                    <td className="py-1 text-sm text-gray-500">{entry.scores.visualFocus || 'N/A'}</td>
                                  </tr>
                                </tbody>
                              </table>
                            </div>
                            ...
                            <div>
                              <h3 className="text-sm font-medium text-gray-700 mb-1">Additional Considerations</h3>
                              <table className="min-w-full">
                                <tbody>
                                  <tr>
                                    <td className="py-1 text-sm font-medium text-gray-900">Storytelling:</td>
                                    <td className="py-1 text-sm text-gray-500">{entry.scores.storytelling || 'N/A'}</td>
                                  </tr>
                                  <tr>
                                    <td className="py-1 text-sm font-medium text-gray-900">Technique Mastery:</td>
                                    <td className="py-1 text-sm text-gray-500">
                            ...
                            <div className="mt-4 pt-4 border-t">
                              <div className="flex justify-between">
                                ...
                                <span className="text-sm font-bold text-gray-900">{entry.scores.total}/10</span>
                              </div>
                            </div>
                          </div>
                        </TabPanel>
                        ...
                        {entry.comments?.length > 0 && (
                          <TabPanel value="comments">
                            <div className="space-y-4">
                              <h3 className="text-sm font-medium text-gray-700">Judge Comments</h3>

                              {entry.comments.map((comment, index) => (
                                <div key={index} className="bg-gray-50 p-3 rounded border">
                                  <p className="text-sm text-gray-700 whitespace-pre-line">{comment}</p>
                                  <p className="text-xs text-gray-500 mt-2">Judge #{index + 1}</p>
                                </div>
                              ))}
                            </div>
                          </TabPanel>
