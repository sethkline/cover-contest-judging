...
import { Info, HelpCircle, AlertCircle, Edit, Trash, Settings, Star, Award } from 'lucide-react';
...
export const LongContent: Story = {
  args: {
    content: 'This is a tooltip with a very long content that will wrap to multiple lines to demonstrate how the tooltip handles longer text content.',
...
export const WithIcon: Story = {
  args: {
    ...
    children: <Info className="h-5 w-5 text-neutral-500 hover:text-neutral-700 cursor-help" />,
  },
};
  ...
  render: () => (
    <div className="flex space-x-2">
      ...
      <Tooltip content="Delete entry">
        <BaseButton variant="ghost" size="sm" className="h-8 w-8 p-0 text-error-500">
  ...
  render: () => (
    <div className="space-y-4 w-80">
      ...
      <div className="space-y-1">
        ...
        <textarea className="w-full border border-neutral-300 rounded-md p-2 text-sm" rows={3} />
      </div>
    </div>
  ),
};
