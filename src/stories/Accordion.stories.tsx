...
import { Info, HelpCircle, Award, Book, Star, Mail, AlertTriangle } from 'lucide-react';
    ...
    <div className="w-96">
      <Accordion>
        <AccordionItem title="What is a contest judging application?">
          <p>
            A contest judging application helps manage art contests by tracking entries,
            assigning judges, and calculating scores. It streamlines the judging process
            and makes it more transparent and efficient.
          </p>
        </AccordionItem>
        
        <AccordionItem title="How are entries scored?">
          <p>
            Entries are scored based on three criteria:
          </p>
          ...
          <p className="mt-2">
            Each category is scored from 0-10, with the final score being an average.
          </p>
        </AccordionItem>
        
        <AccordionItem title="What age categories are available?">
          <p>
            We have three age categories for participants:
          </p>
          <ul className="list-disc pl-5 mt-2 space-y-1">
            <li>Ages 3-7</li>
            <li>Ages 8-11</li>
    ...
    <div className="w-96">
      <Accordion allowMultiple defaultIndex={[0]}>
        <AccordionItem title="Section 1">
          <p>
            Content for section 1. This accordion allows multiple sections to be open at once.
            Try clicking on another section without closing this one.
          </p>
        </AccordionItem>
        
        <AccordionItem title="Section 2">
          <p>
            Content for section 2. You can have multiple sections open simultaneously.
          </p>
        </AccordionItem>
        
        <AccordionItem title="Section 3">
          <p>
            Content for section 3. This is useful when users might want to compare information
  ...
  render: () => (
    <div className="w-96">
      <Accordion>
        ...
        >
          <p>
            Information about the current contests, deadlines, and participation details.
          </p>
        </AccordionItem>
        ...
        >
          <p>
            Guidelines for judges, including scoring criteria and best practices.
          </p>
        </AccordionItem>
...
export const SimpleCollapsible: Story = {
  render: () => (
    <div className="w-96">
      ...
      >
        <p>
          This is a simple collapsible component that can be used for single expandable sections.
          It's a simplified version of the AccordionItem that can be used standalone.
        </p>
      </Collapsible>
    </div>
  ),
      ...
      <Accordion>
        ...
        >
          <div className="space-y-4">
            ...
            <div className="pt-2">
              <BaseButton size="sm" variant="outline">View Details</BaseButton>
            </div>
          </div>
        </AccordionItem>
  ...
  render: () => (
    <div className="w-full max-w-3xl p-6 border rounded-lg bg-white dark:bg-neutral-900">
      ...
      <Accordion className="space-y-4">
        ...
        >
          <p>
            To submit an entry to the contest, follow these steps:
          </p>
          <ol className="list-decimal pl-5 mt-2 space-y-1">
            <li>Log into your account or create a new one.</li>
            <li>Navigate to the "Contests" section and select the contest you wish to enter.</li>
          ...
          <p className="mt-2">
            You'll receive a confirmation email once your entry has been successfully submitted.
          </p>
        </AccordionItem>
        ...
        >
          ...
          <p className="mt-2">
            Please ensure you select the correct age category when submitting your entry.
          </p>
        </AccordionItem>
        ...
        >
          <p>
            Winners are selected through a careful judging process:
          </p>
          <ol className="list-decimal pl-5 mt-2 space-y-1">
            <li>Each entry is reviewed by multiple judges.</li>
            <li>Judges score entries based on creativity, execution, and impact.</li>
            <li>Each category receives a score from 0-10.</li>
            <li>Final scores are calculated as an average of all judges' scores.</li>
            <li>The highest-scoring entries in each age category are selected as winners.</li>
          </ol>
          <p className="mt-2">
            In case of a tie, a panel of senior judges will make the final decision.
          </p>
        </AccordionItem>
        ...
        >
          <p>
            Winners will be announced two weeks after the contest closing date. All 
            participants will be notified via email, and the results will be 
