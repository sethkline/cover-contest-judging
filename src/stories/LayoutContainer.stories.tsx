        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-neutral-500 dark:text-neutral-400">Cover Contest, Bookmark Contest</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-neutral-500 dark:text-neutral-400">Across all contests</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-neutral-500 dark:text-neutral-400">2 pending invitations</div>
            </CardContent>
          </Card>
        </div>
          ...
          <CardContent>
            <div className="space-y-4">
              <div className="pb-4 border-b border-neutral-200 dark:border-neutral-700">
                ...
                <div className="text-sm text-neutral-500 dark:text-neutral-400">Entry #127 in Cover Contest (Ages 8-11)</div>
              </div>
              <div className="pb-4 border-b border-neutral-200 dark:border-neutral-700">
                <div className="font-medium">Judge completed scoring</div>
                <div className="text-sm text-neutral-500 dark:text-neutral-400">Judge Sarah completed scoring 5 entries</div>
              </div>
              <div>
                <div className="font-medium">New judge invitation accepted</div>
                <div className="text-sm text-neutral-500 dark:text-neutral-400">John Doe (john.doe@example.com) has joined as a judge</div>
              </div>
            </div>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-neutral-500 dark:text-neutral-400">Remaining to judge</div>
            </CardContent>
          </Card>
          ...
          <Card>
            ...
            <CardContent>
              ...
              <div className="text-neutral-500 dark:text-neutral-400">Thank you for your contributions!</div>
            </CardContent>
          </Card>
        </div>
      ...
      <div className="max-w-4xl mx-auto space-y-6">
        ...
        <Card>
          ...
          <CardContent>
            <p className="leading-relaxed">
              Our library runs two annual contests for young artists and writers.
              The Cover Contest and Bookmark Contest provide an opportunity for
              creative expression and recognition of talent in our community.
            </p>
          </CardContent>
        </Card>
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <Card>
            ...
            <CardContent>
              <p className="mb-4">
                Create a bookmark design inspired by your favorite story.
                Open to ages 8-11 and 12+.
              </p>
              <button className="px-4 py-2 bg-primary-600 text-white rounded-md hover:bg-primary-700">
                Learn More
              </button>
