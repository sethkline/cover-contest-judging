  ...
  return (
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <p className="mb-4">
          Thank you for agreeing to serve as a judge for our event. Before you begin,
          please take a moment to familiarize yourself with the judging process and criteria.
        </p>
        
        <div className="bg-blue-50 p-4 rounded border border-blue-200 mb-6">
          <h3 className="font-medium text-blue-700 mb-2">Important Information</h3>
          <p className="text-blue-700">
            Once you activate your account, you will have access to all submissions and
            judging tools. Make sure you've reviewed all guidelines before proceeding.
          </p>
        </div>
