    ...
    <div className="max-w-4xl mx-auto p-6">
      ...
      <div className="bg-white shadow-md rounded-lg p-6 mb-6">
        ...
        <div className="space-y-4">
          <p>
            Here are the detailed instructions for judges that will be available at all times,
            regardless of whether you are in pending or active status.
          </p>
          ...
          <div className="bg-gray-50 p-4 rounded border">
            ...
            <p>Each submission should be scored on a scale of 1-10 for each criterion:</p>
