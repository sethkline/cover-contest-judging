...
const mockEntries = [
  {
    ...
    artistStatement:
      "I created this cover to show how God's grace helps us dance through life's challenges.",
  ...
  },
  {
    ...
    frontImageUrl: "/api/placeholder/400/613",
    artistStatement:
      "My design represents how God's grace transforms us and our stories.",
...
export const JudgingFeature: React.FC = () => {
  ...
  const scoredEntries = mockEntries.filter(
  ...
  const handleNextEntry = () => {
    ...
    const currentIndex = mockEntries.findIndex(
              ...
              <div className="flex flex-col md:flex-row md:justify-between md:items-center gap-4">
                <div className="flex-1">
                  ...
                  <ProgressBar
                    ...
                    showValue
                    formatValue={() =>
                      `${scoredEntries} of ${totalEntries} entries scored`
                    }
                  />
                </div>
