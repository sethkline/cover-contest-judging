        ...
        <CardContent className="space-y-6">
          ...
          <div className="pt-4 border-t border-neutral-200 dark:border-neutral-700">
            <div className="flex justify-between text-sm mb-1">
              ...
              <span className="font-bold">{totalScore}/{maxPossible} ({percentage}%)</span>
            </div>
          ...
          <FormField label="Feedback (Optional)" helpText="Provide constructive feedback for the participant">
            <TextArea
